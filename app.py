...
km = st.number_input(
    ...
    placeholder='Enter Kilometer running of your car',min_value=1,max_value=243000,value=None
)
# HP Input
hp = st.number_input(
    "Enter Horsepower of your car",
    placeholder='Enter Horsepower of your car',min_value=69,max_value=192,value=None
)
# cylinders Input
...
weight = st.number_input(
    ...
    placeholder='Enter Weight of your car',min_value=1000,max_value=1615,value=None
)
# Gears Input
gears = st.selectbox(
